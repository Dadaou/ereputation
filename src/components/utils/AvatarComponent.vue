...
<div class="avatar__container" ref=target v-if="userStore.user !== null">
    <div class="avatar__info" @click="hideMenu = !hideMenu">
    ...
    <div v-if="hideMenu" id="userDropdown" class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-50 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <li>
            <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" @click="$router.push(`/users/${userStore.user.id}/profile`)">
                <i class="uil uil-user-square"></i>
                Profile
            </a>
        </li>
        <li>
            <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" @click="$router.push(`/users/${userStore.user.id}/profile/security`)">
