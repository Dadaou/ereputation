      ...
      <div class="mt-5">
        <el-table :data="establishments">
            ...
            <el-table-column  width="200">
                ...
                <template #default="scope">
                   <el-button size="small" @click="showModal = !showModal, establishment=scope.row.uri"
                    ><i class="uil uil-link-add"></i></el-button>
                 
                <el-button size="small" @click="showLinkModal = !showLinkModal, establishment=scope.row.uri"
                    ><i class="uil uil-file-alt"></i></el-button>
                </template>
            </el-table-column>
        </el-table>
    </div>
        ...
        <template #content>
           ...
           <form @submit.prevent="submit" @keydown.enter.prevent="submit" class="mt-4 px-2">
             <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Providers <span>*</span></label>
            ...
            <div>
                <div>
                    ...
                    <label for="link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Paste the link here <span>*</span></label>
                    <p v-if="!isValidLink && link !==''" class="text-red-500 text-sm">Invalid URL format</p>
                    <input type="text" id="link" v-model="link" :class="['bg-gray-50 border border-gray-300 text-gray-900 text-sm w-full p-2', (!isValidLink  && link !=='')?'border-red-500 ring-red-500 text-red-500 focus:border-red-500 focus:ring-red-500 hover:border-red-500 focus:outline-none hover:text-red-500 focus:text-red-500':'']">
                </div>
            </div>
        ...
        <template #content>
            ...
            <ul class="link-list">
                <li v-for="link in filteredLinks">
                    ...
                    <div class="actions">
                        <a :href="link.url" target="_blank" class="external-link"><i class="uil uil-external-link-alt"></i></a>
