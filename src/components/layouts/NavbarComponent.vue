<template>
  <nav ref="nav__ref" class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4" ref="nav__container__ref">
      ...
      <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white" @click="showLang=!showLang">
      ...
      <!-- Dropdown -->
      <div class="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown" v-if="showLang">
        <ul class="py-2 font-medium" role="none">
          ...
          <li>
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
              <div class="inline-flex items-center">
              <svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full me-2" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-fr" viewBox="0 0 512 512">
                <path fill="#0055A4" d="M0 0h170.7v512H0z"/>
                <path fill="#FFF" d="M170.7 0H341.3v512H170.7z"/>
            ...
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
              <div class="inline-flex items-center">
                 <svg aria-hidden="true" class="h-3.5 w-3.5 rounded-full me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <!-- Red stripes -->
                  <path fill="#c60b1e" d="M0 0h512v153.6H0z"/>
                  <path fill="#c60b1e" d="M0 358.4h512V512H0z"/>
                  <!-- Yellow stripe -->
                  <path fill="#ffc400" d="M0 153.6h512v204.8H0z"/>
                  <!-- Coat of arms (simplified) -->
                  <circle cx="256" cy="256" r="50" fill="#0065A4"/>
                  <circle cx="256" cy="256" r="35" fill="#FFD700"/>
                  <path fill="#C60B1E" d="M246 241h20v30h-20z"/>
                </svg>
