        ...
        <el-table :data="filteredLinks">
            ...
            <el-table-column style="width: 25%; min-width: 200px;" align="right">
                ...
                <template #default="scope">
                    ...
                    <el-popconfirm title="Are you sure to delete this?"
                        @confirm="handleDeleteLink(scope.$index, scope.row)">
                        <template #reference>
                            <el-button size="small"><i class="uil uil-trash-alt"></i></el-button>
                        </template>
                    </el-popconfirm>
                ...
                <div>
                    <div>
                        ...
                        <p v-if="!isHashtag && provider" class="text-gray-900 text-sm">Url must start with
                            {{ splitUriAndUrl(provider).baseUrl }}</p>
                ...
                <div class="grid mb-6">
                    <div>
                        ...
                        <el-select v-model="establishments" placeholder="Choose establishment" size="large">
                            <el-option v-for="item in establishment.competitors" :key="item" :label="item.name"
                                :value="item.competitor_id" />
                        </el-select>
                    </div>
                </div>
                <div class="flex items-center justify-between py-4 border-t border-b dark:border-gray-600">
