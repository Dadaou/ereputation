<template>
    <div class="main__container">
        <div class="container mx-auto">
            <div class="validation__qrc_content w-full max-w-md mx-auto bg-gradient-to-br from-purple-600 to-indigo-600 text-white text-center py-5 px-4 md:px-8 lg:px-16 xl:px-20 rounded-lg shadow-md relative">
                ...
                <div class="w-full flex flex-col items-center space-y-4 mb-6">
                    ...
                    <input v-model="couponCode" id="couponCode" type="text" placeholder="Coupon Code" class="input-field form-input mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"/>
                    <button @click="submit" type="submit" :class="['btn btn__light2', showSpinner == true ? 'isLoaded' : '']">
