<template>
    <div class="main__container" style="margin: auto;" v-if="exist">
            ...
            <div class="tablet_mobile__head">
                <div class="staff__card" v-if="staff !== null">
                    <div>
                        ...
                        <ul>
                            <li><span class="label">{{ $t("staffFeedback.departement") }}: </span> <span>{{
                                staff.department
                                    }}</span></li>
                            <li class="Gender">
    ...
    <ModalComponent :showModal="showModal" @close="showModal = false" :width="modalWidth">
        <template #content>
            ...
            <div class="modal__container" v-if="staffs.length > 0">
                <RouterLink v-for="staff in staffs" :key="staff.id" class="staff__card mb-1" :to="{
                    name: 'StaffFeedBack',
                    params: {
                        tag: route.params.tag,
                        etab: staff.establishment_tag,
                        id: staff.tag
                    }
                }" target="_blank">
