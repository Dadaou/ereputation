<template>
  ...
  <div class="main__container" v-if="exist">
    <div class="container mx-auto advantage__qrc_content">
      <div
        class="bg-gradient-to-br from-blue-600 to-indigo-600 text-white text-center py-10 px-4 md:px-8 lg:px-16 xl:px-20 rounded-lg shadow-md relative">
        <div class="flex flex-col lg:flex-row justify-center items-center lg:space-x-8">
          <div class="adv-details mb-8 lg:mb-0">
            <h3 class="text-xl font-semibold mb-4" v-if="advantages">{{ advantages.adv_name }} <br>{{
