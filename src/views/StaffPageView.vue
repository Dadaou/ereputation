<template>
    ...
    <div class="tablet_mobile__filter">
        <DropdownComponent :showTitle="false" class="w-full dropdown" placeholder="" :data="timePeriods" @submit="(timePeriod) => {
            selectedTimePeriod = timePeriod
        }" :default="timePeriods[0]" />
        <div class="px-2 date__picker">
    ...
    <div class="tablet_mobile__head">
        <div class="establishment__info_tablet">
            ...
            <label v-else class="w-full h-3 mt-1 mb-4 bg-gray-200 dark:bg-gray-700"></label>
            <div>
                <i
                ...
                <span v-else class="w-48 h-3 mt-1 mb-4 bg-gray-200 dark:bg-gray-700"></span>
            </div>
            <div class="society__location" v-if="establishment.country != null">
                <i class="uil uil-map"></i>
                <span v-if="!dataLoading">{{ establishment.country }}</span>
                <span v-else class="w-full h-3 mt-1 mb-4 bg-gray-200 dark:bg-gray-700"></span>
            </div>
    ...
    <div class="right__side">
        <div
            class="bg-white border border-gray-200 rounded-lg shadow establishment dark:bg-gray-800 dark:border-gray-700">
...
watch(route_name, async() => {

    const data  = await companiesStore.getEstablishment(customerTag.value, companyId)
    const establishment_name = data?.name ? data?.name  : "Establishment";
