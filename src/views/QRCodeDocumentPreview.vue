      ...
      <div>
        ...
        <form class="my-form" @submit.prevent="submit">
           ...
           <input type="text" id="text3" v-model="text3" >
             ...
             <button class="btn downloads mt-2" @click="previewData">Preview</button><br><br> 
...
.my-form label {
  display: block;
  margin-bottom: 1rem; /* Ajoutez une marge inférieure de 2rem */
...
.my-form input {
  ...
  font-weight: 500; /* Épaisseur de police */
  color: #333; /* Couleur du texte */
  padding: 0.5rem 1rem; /* Ajoutez un remplissage pour le texte d'entrée */
...
.my-form button {
  ...
  border: 100%px solid #ccc; /* Ajoutez une bordure */
  border-radius: 0.25rem; /* Ajoutez un rayon de bordure */
}
